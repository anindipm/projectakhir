...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 23 Mar 2021 pada 15.56
...
(119, 'Flash Nikon Speedlight SB-910', '', 180000),
...
INSERT INTO `penyewaan` (`kode_barang`, `idpelanggan`, `nama_barang`, `tgl_sewa`, `lama_sewa`, `harga_sewa`) VALUES
(111, 1, 'DSLR Canon EOS 90D', '2020-08-03', 1, 100000),
(112, 2, '	DSLR Canon EOS 6D Mark II', '2020-08-19', 1, 150000),
(113, 4, 'Flash Canon Speedlite 600EX-RT', '2020-11-01', 1, 130000),
(116, 5, 'DSLR Canon EOS 700D', '2021-03-23', 2, 300000);
...
(2, 'rania', 'rani', '2020-08-13 17:42:23', '2021-03-23 14:03:03', 'A', '1'),
...
(11, 'admin', 'rania', '2021-03-23 21:31:01', '0000-00-00 00:00:00', 'A', '1');
...
--
ALTER TABLE `penyewaan`
  MODIFY `kode_barang` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=117;
